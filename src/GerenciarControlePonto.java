...
public class GerenciarControlePonto {
    ...
    public static void main(String[] args) {
        ...
        gerente.setLogin("Thaynra");
        gerente.setSenha("123456");
        gerente.setDocumento("69.123-0");
        gerente.setEmail("thaynara@hotmail.com");
        gerente.setNome("Thaynara Polettini");
        gerente.setIdFunc(1);
        gcp.funcList.add(gerente);

        Secretaria secretaria = new Secretaria();
        secretaria.setDocumento("687.586-0");
        secretaria.setEmail("claudia@hotmail.com");
        secretaria.setNome("Claudia Santos");
        ...
        operador.setDocumento("066.332-0");
        operador.setEmail("diego@hotmail.com");
        operador.setNome("Diego Luiz");
